...
class TestDatabaseOperations(unittest.TestCase):
    def setUp(self):
        ...
        self.client = MongoClient("mongodb+srv://akhilantonyjoseph1997:5dsTWl4KxKTWbOea@vortex0.hvopo.mongodb.net/?retryWrites=true&w=majority&appName=Vortex0")  # Removed actual string.
